...
Forked from https://github.com/Police-Data-Accessibility-Project/Scrapers/tree/master/scrapers_library/data_portals/Scrapers/Cityprotect_base_scraper.py
"""
