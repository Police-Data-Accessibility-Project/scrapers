...
Forked from https://github.com/Police-Data-Accessibility-Project/Scrapers/tree/master/scrapers_library/data_portals/cityprotect/Cityprotect_base_scraper.py
"""
