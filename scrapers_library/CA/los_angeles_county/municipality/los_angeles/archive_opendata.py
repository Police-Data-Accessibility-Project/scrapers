...
save_url = [
    ...
    [
        "drugs_poss/2010-2019/",
        "https://data.lacity.org/api/views/isxh-ztfe/rows.csv?accessType=DOWNLOAD",
    ],
    ...
    [
        "response_metrics/all_stations/",
        "https://data.lacity.org/resource/kszm-sdw4.csv",
    ],
    ...
    [
        "response_metrics/all_stations/2014/",
        "https://data.lacity.org/resource/y2p7-8ckf.csv",
    ],
    [
        "response_metrics/citywide/2015/",
        "https://data.lacity.org/resource/jk5m-4dqg.csv",
    ],
    [
        "response_metrics/citywide/2016/",
        "https://data.lacity.org/resource/8d58-axgy.csv",
    ],
    [
        "response_metrics/citywide/unsure/",
        "https://data.lacity.org/resource/adam-59ei.csv",
    ],
    [
        "response_metrics/all_stations/2015/",
        "https://data.lacity.org/resource/if3i-rtyg.csv",
    ],
    ["cfs/2018/", "https://data.lacity.org/resource/nayp-w2tw.csv"],
    [
        "response_metrics/citywide/2017/",
        "https://data.lacity.org/resource/t69g-g3uk.csv",
    ],
    [
        "response_metrics/all_stations/2013/",
        "https://data.lacity.org/resource/x88u-8etg.csv",
    ],
    ["cfs/2012/", "https://data.lacity.org/resource/i7pm-cnmm.csv"],
    [
        "response_metrics/all_stations/2016/",
        "https://data.lacity.org/resource/ieyn-ppaw.csv",
    ],
    [
        "response_metrics/all_stations/2017/",
        "https://data.lacity.org/resource/rub2-5ih6.csv",
    ],
    [
        "response_metrics/citywide/2014/",
        "https://data.lacity.org/resource/txgp-mc85.csv",
    ],
]
