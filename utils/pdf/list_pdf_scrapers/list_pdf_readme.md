...
If this does not make sense, try checking the comments within the code. (if you can find any)
 Working example can be found [here](https://github.com/Police-Data-Accessibility-Project/PDAP-Scrapers/blob/master/scrapers/CA/fresno_county/college/fresno/fresno_daily_scraper.py)
