...
If this does not make sense, try checking the comments within the code.
 Working example can be found [here](https://github.com/Police-Data-Accessibility-Project/scrapers/blob/main/scrapers_library/CA/alameda_county/alameda/alameda_police/alameda_scraper.py)
